...
class CommunalDataAdapter(
    private val selectionListener: (CommunalDataModel) -> Unit
) : ListAdapter<CommunalDataModel, CommunalDataAdapter.ViewHolder>(ItemCallback()) {
    ...
    class ViewHolder private constructor(
        ...
        fun bind(data: CommunalDataModel, selectionListener: (CommunalDataModel) -> Unit) {
    ...
    class ItemCallback : DiffUtil.ItemCallback<CommunalDataModel>() {
        override fun areItemsTheSame(
            oldItem: CommunalDataModel,
            newItem: CommunalDataModel
        ): Boolean {
